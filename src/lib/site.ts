  ...
  },
  {
    ...
    writeup: {
      ...
      tech: [
        ...
        "Recharts: 상위 수종 통계(전국·지역)",
        "Tailwind: 패널/모바일 UI",
        "Node.js 스크립트: 데이터 파싱·가공·마커 JSON 생성",
        "Turf · proj4 · shapefile: 중심점/공간 처리, 제주 경계 변환",
      ],
      problemSolving: [
    ...
    oneLiner:
      "전국 보호수 현황을 choropleth(4단계 구간)로 비교하고, 가능 지역은 클러스터 → 개별 마커로 확대 탐색까지 이어지도록 만든 웹 서비스입니다.",
    period: "2026.03",
    problem:
